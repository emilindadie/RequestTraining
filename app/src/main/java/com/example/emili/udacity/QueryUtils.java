...
public final class QueryUtils {
    private static final String LOG_TAG = "zrzer";
    static Context context;



    private static Contact contactSolo;
static StringBuilder sb;
    ...
    public static List<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray features = mainObject.getJSONArray("features");
            for (int i = 0; i < features.length(); i++) {
                JSONObject main = features.getJSONObject(i);
                JSONObject properties = main.getJSONObject("properties");
                double magnitude = properties.getDouble("mag");
                String location = properties.getString("place");
                long timeInMilliSeconds = properties.getLong("time");
                Earthquake list = new Earthquake(magnitude, location, timeInMilliSeconds);
    ...
    static List<Contact> makeHttpRequest(Context context, String url){
        QueryUtils.context = context;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
               // contactList1[0] = handleResponse(response);
            }
        ...
        Contact contactSolo = new Contact("er", "ffg", "fff");
        contactList1.add(contactSolo);

        //requestQueue.add(stringRequest);
        return contactList1;
    }

   static List<Contact> handleResponse(String response) {
        List<Contact> contactsList2 = new ArrayList<>();
        try {
